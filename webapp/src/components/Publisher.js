  ...
  render() {
    if (!this.state.ready) {
      ...
      return <div>
        ...
        {this.state.info.access_logs && <div className={styles.section}>
  ...
  return <div className="table-responsive">
    <table className="table table-hover table-bordered">
      ...
      <tr>
        ...
        <th className="griddle-table-heading-cell"><OpenAccessHeadingComponent className=""/></th>
        <th className="griddle-table-heading-cell"><ActiveHeadingComponent className=""/></th>
      </tr>
      </thead>
